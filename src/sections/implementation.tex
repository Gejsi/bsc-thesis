...
and a new import statement added at the top of the file.
\annotation{\$TrackMetrics} puts the code in a context-aware manner, hence,
it is placed after the variable declared as the third argument.
