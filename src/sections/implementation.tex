...
\f{} offers four core annotations which generate code and/or metadata.
Their transformers can handle code manipulation, deployment metadata, or a combination of both functionalities:
