...
type Dollar = number
type Euro = number
declare function foo(n: Dollar): void
declare const e: Euro
...
have greatly boosted \textit{TypeScript} popularity at every scale of software development.
...
\begin{itemize}
  ...
  \item Enriched build pipeline. Before \textit{TypeScript} existed, projects
    ...
    supported yet. \textit{TypeScript} simplifies this workflow since it provides
